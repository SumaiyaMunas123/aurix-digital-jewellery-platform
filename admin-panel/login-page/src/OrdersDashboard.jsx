      ...
      <div className="od-modal">
        ...
        <div className="od-modal-body">
          <div className="od-modal-section">
            ...
            {customer?.phone && (
              <p className="od-modal-sub">{customer.phone}</p>
            )}
          </div>

          <div className="od-modal-section">
            <h4 className="od-modal-section-title">Jeweller</h4>
            <p className="od-modal-val">
              {jeweller?.business_name || jeweller?.name || "—"}
            </p>
          ...
          <div className="od-modal-section">
            ...
            <div className="od-modal-details-grid">
              <div>
                <span className="od-modal-key">Qty</span>
                <span className="od-modal-val">{order.quantity}</span>
              </div>
              <div>
                <span className="od-modal-key">Total</span>
                <span className="od-modal-val od-modal-total">
                  LKR {(order.total_price || 0).toLocaleString("en-LK")}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="od-table-wrapper">
            <table className="od-table">
              ...
              <tbody>
                {loading ? (
                  <tr>
                    <td colSpan="8" className="od-empty">
                      Loading orders…
                    </td>
                  </tr>
                ) : error ? (
                  ...
                  filtered.map((o) => (
                    <tr key={o.id}>
                      ...
                      <td className="od-amount">
                        LKR{" "}
                        {(o.total_price || 0).toLocaleString("en-LK", {
                      ...
                      <td>
                        <span
                          className={
                            STATUS_CLASS[o.status] || "od-pill od-pending"
                          }
                        >
