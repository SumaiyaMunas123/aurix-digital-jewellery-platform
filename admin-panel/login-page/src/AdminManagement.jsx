    ...
    <div className="am-form-group full">
      ...
      {value && (
        <div className="am-pw-strength">
          ...
          {strength.label && (
            <div
              className="am-pw-strength-label"
...
function PhoneField({ value, phoneCode, onValueChange, onCodeChange, error }) {
  return (
    <div className="am-form-group full">
      <label>
        Phone Number{" "}
        <span style={{ fontWeight: 400, color: "#ccc", textTransform: "none" }}>
          (optional)
        </span>
      </label>
      <div className="am-phone-wrap">
        <select
          className="am-phone-code"
          value={phoneCode}
        ...
        <input
          ...
          value={value}
          onChange={(e) =>
            onValueChange(e.target.value.replace(/[^\d\s]/g, ""))
          }
...
export default function AdminManagement() {
  ...
  return (
    <div className="am-page">
      {toast && (
        <div
          className={`am-toast ${toast.type === "success" ? "am-toast-success" : "am-toast-error"}`}
        >
      ...
      <div className="am-stats-row">
        {[
          ...
          {
            label: "Senior Admins",
            value: admins.filter((a) => a.role === "Senior Admin").length,
          },
        ].map((s) => (
              ...
              filtered.map((admin) => {
                ...
                return (
                  <tr key={admin.id}>
                    <td>
                      <div className="am-admin-cell">
                        <div className="am-admin-name-row">
                          ...
                          {admin.isCurrent && (
                            <span className="am-you-pill">You</span>
                          )}
                        </div>
                    ...
                    <td>
                      <span
                        className={`am-status ${admin.status === "Active" ? "active" : "inactive"}`}
                      >
                        {admin.status}
                      </span>
                    </td>
          ...
          <div className="am-modal" onClick={(e) => e.stopPropagation()}>
            <div className="am-confirm-modal">
              ...
              <p>
                ...
                <strong>{deleteAdmin.name}</strong>?<br />
              ...
              <div className="am-confirm-actions">
                ...
                <button
                  className="am-modal-delete"
                  onClick={() => handleDelete(deleteAdmin.id)}
                >
                  Remove
                </button>
              </div>
        ...
        <div className="am-modal-form">
          ...
          <div className="am-modal-grid">
            <div className="am-modal-group">
              ...
              />
              {errors.firstName && (
                <div className="am-field-error">{errors.firstName}</div>
              )}
            </div>
            <div className="am-modal-group">
              ...
              />
              {errors.lastName && (
                <div className="am-field-error">{errors.lastName}</div>
              )}
            </div>
            <div className="am-modal-group">
              <label>Role</label>
          ...
          <div className="am-modal-grid">
            <div className="am-modal-group" style={{ gridColumn: "1 / -1" }}>
              ...
              />
              {errors.email && (
                <div className="am-field-error">{errors.email}</div>
              )}
            </div>
            <div className="am-modal-group" style={{ gridColumn: "1 / -1" }}>
              <PhoneField
          ...
          <div className="am-modal-footer">
            ...
            <button className="am-modal-submit" onClick={handleSubmit}>
              Add Administrator
            </button>
          </div>
        </div>
        ...
        <div className="am-modal-form">
          ...
          <div className="am-modal-footer">
            ...
            <div style={{ marginLeft: "auto", display: "flex", gap: 8 }}>
              ...
              <button className="am-modal-submit" onClick={handleSave}>
                Save Changes
              </button>
            </div>
          </div>
