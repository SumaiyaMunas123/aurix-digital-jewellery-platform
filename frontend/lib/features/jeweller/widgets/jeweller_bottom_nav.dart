          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  _item(context, 0, Icons.dashboard_rounded),
                  _item(context, 1, Icons.inventory_2_rounded),
                  _item(context, 2, Icons.chat_bubble_rounded),
      ...
      child: InkResponse(
        ...
        child: AnimatedContainer(
          ...
          child: Icon(
            ...
            size: 24,
            color:
                selected ? AppColors.gold : (isDark ? Colors.white : Colors.black),
          ),
        ),
      ),
    );
